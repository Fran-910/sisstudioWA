        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KitsProductos_Productos_KitId",
                        column: x => x.KitId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KitsProductos_Productos_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificacionesStocks_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificacionesStocks_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitsProductos_KitId",
                table: "KitsProductos",
                column: "KitId");

            migrationBuilder.CreateIndex(
                name: "IX_KitsProductos_ProductoId",
                table: "KitsProductos",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificacionesStocks_ProductoId",
                table: "NotificacionesStocks",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificacionesStocks_UsuarioId",
                table: "NotificacionesStocks",
                column: "UsuarioId");
